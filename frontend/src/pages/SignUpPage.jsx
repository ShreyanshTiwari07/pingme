    ...
    <div className="min-h-screen bg-gradient-to-br from-pine-900 via-pine-700 to-pine-400 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-pine-100">Create your account</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <User className="h-5 w-5 text-pine-700" />
                </div>
                <input
                  type="text"
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/login" className="text-pine-900 font-semibold hover:text-pine-700">
                Sign in
              </Link>
            </p>
          </div>
